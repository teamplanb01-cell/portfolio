  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="flex items-end justify-between mb-6">
        ...
        <Link to="/projects" className="text-primary hover:underline">See all</Link>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {featured.map((p, idx) => (
          ...
          >
            <div className="aspect-[16/9] rounded-xl bg-black/30 mb-3 flex items-center justify-center">
